...
# Bottom-right hot corner → Quick Note (14). Modifier 0 = none.
defaults write com.apple.dock wvous-br-corner -int 14
defaults write com.apple.dock wvous-br-modifier -int 0

# Dock app order (persistent-apps) is a binary blob — not scripted here.
# Current: Arc, Firefox, Obsidian, zoom.us, Microsoft Outlook, Slack, Reminders, Supacode.
# Arrange by hand; the layout persists in the live plist.
...
# Menubar item layout (Control Center, order/visibility) lives in
# com.apple.controlcenter as opaque "NSStatusItem Preferred Position" blobs —
# too fiddly to script reliably. Arrange by hand (Cmd-drag in the menubar).
